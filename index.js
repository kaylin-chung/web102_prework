...
const formattedContributions = totalContributions.toLocaleString();

// set the inner HTML using a template literal and toLocaleString to get a number with commas
contributionsCard.innerHTML = `
    <p>${formattedContributions}</p>
`;
...
const statement = `
    ...
    ${unfundedGamesCount === 0 ? 'All games are funded!' : `Currently ${unfundedGamesCount} games remain unfunded.
...
descriptionContainer.appendChild(statementElement);
